...
import willms.blog.service.BoardService;
...
//	public ResponseDto<Integer> saveReply(@PathVariable int boardId, @RequestBody Reply reply,
//			@AuthenticationPrincipal PrincipalDetail principal) {
//
...
//	}
	//DTODTODTO
	@PostMapping("/api/board/{boardId}/reply")
	public ResponseDto<Integer> saveReply(@RequestBody ReplySaveRequestDto replyDto) {
